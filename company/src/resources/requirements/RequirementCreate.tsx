...
const TypedGrid = Grid as unknown as React.FC<
  GridProps & { item?: boolean; xs?: number; sm?: number; md?: number }
>;
              ...
              <FormGroup row>
                <Grid container spacing={1}>
                  {regionPrefs.map((pref) => (
                    <TypedGrid item xs={6} sm={4} md={3} key={pref.id}>
                      <FormControlLabel
                        control={
                          <Checkbox
...
export const RequirementCreate = () => {
  ...
  const defaultValues = {
    ...
    various_allowances: [
      {
        name: "",
        first_allowance: null,
        second_allowance: null,
        third_allowance: null,
        fourth_allowance: null,
      },
    ],
  };
